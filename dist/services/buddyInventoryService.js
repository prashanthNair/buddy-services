...
exports.BuddyInventoryService = void 0;
const db_config_1 = require("../configuration/db.config");
class BuddyInventoryService {
    constructor() { }
    static getInstance() {
    ...
    postBuddyInventory(buddyInventoryData) {
...
exports.BuddyInventoryService = BuddyInventoryService;
BuddyInventoryService.instance = null;
//# sourceMappingURL=buddyInventoryService.js.map