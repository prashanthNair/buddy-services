...
const teamRoutes = (app, teamController: TeamController = TeamController.getInstance()) => {
   ...
   *                 
  */
app.route('/api/v1/team/:buddyId')
.get(async (req: Request,
    res: Response,
    next: NextFunction) =>
    await teamController.listAllTeamMembers(req, res,next))
}
